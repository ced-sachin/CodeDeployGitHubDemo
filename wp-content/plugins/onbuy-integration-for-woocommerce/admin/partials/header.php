...
<div class="navigation-wrapper">
	...
	<ul class="navigation">
		<li>
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=ced_onbuy&section=onbuy-settings&shop_id=' . $shop_id ) ); ?>" class="
				<?php
				if ( 'onbuy-settings' == $section ) {
					echo 'active';
				}
				?>
		...
		<li>
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=ced_onbuy&section=onbuy-category&shop_id=' . $shop_id ) ); ?>" class="
			<?php
			if ( 'onbuy-category' == $section ) {
				echo 'active';
			}
			?>
		...
		<li>
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=ced_onbuy&section=onbuy-profile&shop_id=' . $shop_id ) ); ?>" class="
				<?php
				if ( 'onbuy-profile' == $section ) {
					echo 'active';
				}
				?>
		...
		<li>
			<a class="
			<?php
			if ( 'onbuy-products' == $section ) {
				echo 'active';
			}
			?>
			" href="<?php echo esc_url( admin_url( 'admin.php?page=ced_onbuy&section=onbuy-products&shop_id=' . $shop_id ) ); ?>"><?php esc_html_e( 'Products', 'onbuy-integration-by-cedcommerce' ); ?></a>
		</li>
		<li>
			<a class="
			<?php
			if ( 'onbuy-queue' == $section ) {
				echo 'active';
			}
			?>
			" href="<?php echo esc_url( admin_url( 'admin.php?page=ced_onbuy&section=onbuy-queue&shop_id=' . $shop_id ) ); ?>"><?php esc_html_e( 'Queue Management', 'onbuy-integration-by-cedcommerce' ); ?></a>
		</li>
		<li>
			<a class="
			<?php
			if ( 'onbuy-orders' == $section ) {
				echo 'active';
			}
			?>
			" href="<?php echo esc_url( admin_url( 'admin.php?page=ced_onbuy&section=onbuy-orders&shop_id=' . $shop_id ) ); ?>"><?php esc_html_e( 'Orders', 'onbuy-integration-by-cedcommerce' ); ?></a>
		</li>
		<li>
			<?php
			$url = admin_url( 'admin.php?page=ced_onbuy&section=onbuy-timeline&shop_id=' . $shop_id );
			?>
			<a class="
			<?php
			if ( 'onbuy-timeline' == $section ) {
				echo 'active'; }
			?>
