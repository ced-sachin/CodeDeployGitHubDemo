...
class Ced_Onbuy_Account_Table extends WP_List_Table {
	...
	public function column_configure( $item ) {
		$button_html = "<a class='button-primary' href='" . admin_url( 'admin.php?page=ced_onbuy&section=onbuy-settings&shop_id=' . $item['shop_id'] ) . "'>" . __( 'Configure', 'onbuy-integration-by-cedcommerce' ) . '</a>';
		return $button_html;
	}
	...
	public function process_bulk_action() {
		...
		if ( 'bulk-delete' === $this->current_action() || ( isset( $_GET['action'] ) && 'bulk-delete' === $_GET['action'] ) || ( isset( $_GET['action2'] ) && 'bulk-delete' === $_GET['action2'] ) ) {
			...
			switch ( $section ) {
				case 'onbuy-settings':
					$file = CED_ONBUY_DIRPATH . 'admin/partials/settings-view.php';
					break;
				case 'onbuy-category':
					$file = CED_ONBUY_DIRPATH . 'admin/partials/category-mapping-view.php';
					break;
				case 'onbuy-profile':
					$file = CED_ONBUY_DIRPATH . 'admin/partials/ced-onbuy-profile-listing.php';
					break;
				case 'onbuy-products':
					$file = CED_ONBUY_DIRPATH . 'admin/partials/class-onbuylistproducts.php';
					break;
				case 'onbuy-queue':
					$file = CED_ONBUY_DIRPATH . 'admin/partials/class-onbuyQueueManagement.php';
					break;
				case 'onbuy-orders':
					$file = CED_ONBUY_DIRPATH . 'admin/partials/class-ced-onbuy-list-orders.php';
					break;
				case 'onbuy-timeline':
					$file = CED_ONBUY_DIRPATH . 'admin/partials/ced-onbuy-timeline.php';
					break;
			}
