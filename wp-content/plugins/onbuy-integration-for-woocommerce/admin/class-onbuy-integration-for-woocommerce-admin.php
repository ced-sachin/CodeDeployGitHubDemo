...
class Ced_Onbuy_Integration_For_Woocommerce_Admin {
	...
	public function load_dependency() {
		...
		$onbuy_activity            = new Onbuy_Activities();
		$GLOBALS['onbuy_activity'] = $onbuy_activity;
	}
	...
	public function enqueue_styles() {
		...
		if ( isset( $_GET['page'] ) && ( 'ced_onbuy' == $_GET['page'] || 'cedcommerce-integrations' == $_GET['page'] ) ) {
			wp_enqueue_style( 'ced-boot-css', 'https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', array(), $this->version, 'all' );
	...
	public function ced_onbuy_process_bulk_action() {
		...
		if ( $check_ajax ) {
			...
			if ( 'upload_product' == $operation ) {
				...
				echo '<pre>'; print_r($get_product_detail); die(__METHOD__);
